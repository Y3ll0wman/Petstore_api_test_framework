...
def create_user_with_input_list(api_url, headers):
    ...
    try:
        ...
        create_user_with_input_list_request = \
            user_create_with_input_list.CreateUserWithInputListRequest.parse_raw(user_create_with_input_list.input_json)
        # Выводим на печать Request body
        print(f'Request body: {user_create_with_input_list.input_json}')
        ...
        response = requests.request('POST', f'{api_url}/v2/user/createWithList',
